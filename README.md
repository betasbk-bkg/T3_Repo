...
## v1.1.0 Changes From v1.0.12

- Manuscript source replaced with the current submission text (`manuscript/t3main_SREP_submission_v1_0.docx`, with markdown source `t3main_SREP_submission_v1_0.md`): restructured into Introduction/Results/Discussion/Methods order, retitled, related-work discussion condensed into the Introduction, references converted to numbered order-of-appearance style, tables and figures renumbered accordingly, and two typographic omissions of R^2 in the reduced-order comparison text repaired. No data, code, figures, or numerical results were changed.
